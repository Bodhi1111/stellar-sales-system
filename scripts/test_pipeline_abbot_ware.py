#!/usr/bin/env python3
"""
Test full pipeline with Abbot Ware real transcript
...
async def main():
    print("="*80)
    print("FULL PIPELINE TEST - Abbot Ware Transcript")
    print("="*80)
    print()
    ...
    transcript_path = Path("/Users/joshuavaughan/Library/CloudStorage/GoogleDrive-jvaughan27@gmail.com/.shortcut-targets-by-id/1oyouGXIJLyId2y2H-JJVYay9GFpnLTDK/McAdams Transcripts/Abbot Ware: Estate Planning Advisor Meeting.txt")
    ...
    try:
        ...
        print()
        print(f"✅ Success! Real transcript processed end-to-end with Mistral 7B")
